...
/* ✅ ONLY ADDITION FOR THIS REQUEST: count user searches only (ignore alert scraping) */
...
async function handleSummary(req, res) {
  try {
    ...
    // ✅ ONLY CHANGE: searches should be REAL user searches only (type='search')
    // This avoids 'search_course' etc from the alert worker inflating search count.
    ...
    try {
      ...
      console.warn("User-search count query failed (non-fatal):", e?.message || e);
